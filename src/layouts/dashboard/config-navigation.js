      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          // PRODUCT
          {
            ...
            icon: ICONS.truck,
            children: [
              { title: t('new'), path: paths.dashboard.post.new },
          ...
          // ORDER
          {
            ...
            icon: ICONS.booking,
            children: [
              { title: t('new'), path: paths.dashboard.product.new },
...

          {
            ...
            icon: ICONS.user,
            children: [
              { title: t('new'), path: paths.dashboard.user.new },
          ...
          // INVOICE
          {
            ...
            icon: ICONS.invoice,
            children: [
              { title: t('new'), path: paths.dashboard.invoice.new },
